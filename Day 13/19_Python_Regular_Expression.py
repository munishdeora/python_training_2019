...
"""
# if the string "easily" is a substring of the string "Regular expressions easily explained!"
...
A quantifier after a token, which can be a single character or group in brackets, specifies how often that preceding element is allowed to occur. The most common quantifiers are
    ...
    the question mark ?
    the asterisk or star character *, zero or more
...
"""
#all meta characters needs to be escaped if we wan it to be searched
# . ^ $ + ? { } [ ] \ | ( ) 
